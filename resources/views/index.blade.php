	...
	<section id="slider">
		<div id="home-carousel" class="carousel slide" data-ride="carousel">			
			<div class="carousel-inner">
				<div class="item active" style="background-image:url({{URL:: asset('images/slider/01.jpg')}}) ">
				...
				<div class="item" style="background-image: url({{URL:: asset('images/slider/02.jpg')}})">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h1>You are entire </h1>
				...
				<div class="item" style="background-image: url({{URL:: asset('images/slider/03.jpg')}})">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h1>You are entire </h1>
				...
				<div class="item" style="background-image:url({{URL:: asset('images/slider/04.jpg')}})">
					<div class="carousel-caption container">
						<div class="row">
							<div class="col-sm-7">
								<h1>You are entire </h1>
					...
					<div class="portfolio-items">
						...
						<div class="col-md-4 col-sm-6 work-grid wordpress graphic">
							<div class="portfolio-content">
								<img class="img-responsive" src="{{URL:: asset('images/works/portfolio-1.jpg')}}" alt="">
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-1.jpg'): URL::route('sign-in')}}"><i class="fa fa-camera-retro"></i></a>
						...
						<div class="col-md-4 col-sm-6 work-grid html php bootstrap">
							<div class="portfolio-content">
								<img class="img-responsive" src="{{URL:: asset('images/works/portfolio-2.jpg')}}" alt="">
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-2.jpg'): URL::route('sign-in')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid wordpress graphic">
							<div class="portfolio-content">
								<img class="img-responsive" src="{{URL:: asset('images/works/portfolio-3.jpg')}}" alt="">
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-3.jpg'): URL::route('sign-in')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid html php bootstrap">
							<div class="portfolio-content">
								<img class="img-responsive" src="{{URL:: asset('images/works/portfolio-4.jpg')}}" alt="">
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-4.jpg'): URL::route('sign-in')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid wordpress graphic php">
							<div class="portfolio-content">
								<img class="img-responsive" src="{{URL:: asset('images/works/portfolio-5.jpg')}}" alt="">
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-5.jpg'): URL::route('sign-in')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
						...
						<div class="col-md-4 col-sm-6 work-grid html bootstrap graphic">
							<div class="portfolio-content">
								<img class="img-responsive" src="{{URL:: asset('images/works/portfolio-6.jpg')}}" alt="">
								<div class="portfolio-overlay">
									<a href="{{(Auth::check())? URL:: asset('images/works/portfolio-6.jpg'): URL::route('sign-in')}}"><i class="fa fa-camera-retro"></i></a>
									<h5>Web Development</h5>
									<p>Design, Develop</p>
								</div>
							</div>	
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-3 col-sm-6">
					<div class="team-member">
						<div class="member-image">
							<img class="img-responsive" src="{{URL:: asset('images/members/team1.jpg')}}" alt="">
				...
				<div class="col-md-3 col-sm-6">
					<div class="team-member">
						<div class="member-image">
							<img class="img-responsive" src="{{URL:: asset('images/members/team2.jpg')}}" alt="">
							<div class="member-social">
								<a href=""><i class="fa fa-facebook"></i></a>
								<a href=""><i class="fa fa-twitter"></i></a>
								<a href=""><i class="fa fa-google-plus"></i></a>
					...
					<div id="office-carousel" class="carousel slide" data-ride="carousel">			
						<div class="carousel-inner">
							<div class="item active">
								<img src="{{URL:: asset('images/office/04.jpg')}}" alt="">
							</div>
							<div class="item">
								<img src="{{URL:: asset('images/office/02.jpg')}}" alt="">			
							</div>
							<div class="item">
								<img src="{{URL:: asset('images/office/03.jpg')}}" alt="">			
							</div>
